...
- [x] **Step 2: Add explicit project metadata**
...
- [x] **Step 3: Add shared lookup helpers**
...
- [x] **Step 1: Make shell behavior explicit**
...
- [x] **Step 2: Rebuild desktop rail markup**
...
- [x] **Step 1: Give writing cards explicit variants**
...
- [x] **Step 2: Structure homepage editorial positions**
...
- [x] **Step 4: Add editorial and archive CSS**
...
- [x] **Step 1: Build static counterpart switch**
...
- [x] **Step 2: Wire article counterparts**
...
- [x] **Step 3: Wire project counterparts**
...
- [x] **Step 4: Complete author and alternate metadata**
...
- [x] **Step 1: Fetch official font assets**
...
- [x] **Step 4: Scan visual constraints**
...
- [x] **Step 5: Verify mobile and keyboard behavior**
...
- [x] **Step 6: Verify generated metadata**
...
- [x] **Step 7: Mark plan complete and commit fixes**
